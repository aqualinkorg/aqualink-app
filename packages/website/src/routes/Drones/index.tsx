  ...
  return (
    <>
      ...
      <div>
        ...
        <meta property="og:url" content="https://www.aqualink.org/drones/" />
        <meta
          property="og:description"
          content="Drones - An Affordable Autonomous Surface Vehicle"
        />
        <link rel="shortcut icon" type="image/png" href="../favicon.png" />
        <link
          rel="stylesheet"
          type="text/css"
          href="../css/bootstrap.css?9840"
        />
        <link rel="stylesheet" type="text/css" href="../style.css?1797" />
        <link
          rel="stylesheet"
          type="text/css"
                    ...
                    <div className="row dronecardrow align-items-center">
                      <div className="col-sm-12 order-sm-1 col-lg-7 col-md-10 offset-md-1 offset-lg-0">
                        ...
                        <p>
                          ...
                          Autonomous Surface Vehicle(ASV) is open source, built
                          on top of existing frameworks like Pixhawk and ROS and
                          uses a NVIDA Jetson GPU combined with machine vision
                          stereo cameras.
                        </p>
                      </div>
                ...
                <div className="col">
                  <div className="row align-items-start">
                    <div className="col">
                      ...
                      <p>
                        The BOM Cost for the power system, electronics, and
                        motors – everything except for the hull, is less than
                        $2,500. To build your own ASV you’ll need to get your
                        own hull. We understand this makes things harder and we
                        have a completed hull design but would like to
                        understand how useful this is to the conservation
                        community. If there’s enough interest, we’ll start the
                        tooling investment and make it generally available.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="row align-items-center voffset-lg">
                    ...
                    <div className="order-1 order-sm-0 order-lg-1 order-md-1 col-md-10 offset-md-1 offset-lg-1 col-lg-6">
                      <ul>
                        ...
                        <li>
                          <p>
                            The primary hull can travel on battery power alone
                            for about 16km
                            <br />
                          </p>
                        </li>
                  ...
                  <div className="row align-items-center voffset-lg">
                    <div className="offset-lg-0 order-lg-0 order-md-1 col-md-10 offset-md-1 order-sm-1 col-lg-6 order-1">
                      <ul>
                        ...
                        <li>
                          <p>
                            Mechanical mounting bracket with ability to run
                            wires for power and communications into the center
                            hull
                            <br />
                          </p>
                        </li>
...
type DronesProps = WithStyles<typeof styles>;

export default withStyles(styles)(Drones);
