              ...
              <div className="row faqq">
                <div className="col">
                  ...
                  <p>
                    ...
                    click on "ADD NEW SURVEY". Follow the steps and add comments
                    and pictures to your survey session.
                    <br />
                    <br />
              ...
              <div className="row faqq">
                <div className="col">
                  ...
                  <p>
                    ...
                    point, you'll see all the surveys conducted at that survey
                    point chronologically. This enables you to monitor a single
                    point in your reef over a longer period.
                  </p>
                </div>
              </div>
              <div className="row faqq">
              ...
              <div className="row faqq">
                <div className="col">
                  ...
                  <p>
                    ...
                    "HOBO data" sensor type. If you are using a HOBO temperature
                    logger, you can upload the raw data file. If you're using
                    any other type of temperature logger, add a column for time
                    and date and another column for temperature. Please use this
                    <a
