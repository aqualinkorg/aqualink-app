...
### Project READMEs
The following documentation comes from the main repository README files:
- ./README.md - Main project README
- ./packages/api/README.md - API package documentation
- ./packages/website/README.md - Website package documentation

## MAIN PROJECT (from ./README.md)
