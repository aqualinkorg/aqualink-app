...
export class AddDataUploadsTable1642002182959 implements MigrationInterface {
  name = 'AddDataUploadsTable1642002182959';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."data_uploads_sensor_type_enum" AS ENUM('gfs', 'hobo', 'noaa', 'spotter', 'sonde')`,
    );
    await queryRunner.query(
      `CREATE TABLE "data_uploads" ("id" SERIAL NOT NULL, "sensor_type" "public"."data_uploads_sensor_type_enum" NOT NULL, "min_date" TIMESTAMP NOT NULL, "max_date" TIMESTAMP NOT NULL, "site_id" integer, "survey_point_id" integer, CONSTRAINT "REL_1ed4a7be821c5819d382e4b72e" UNIQUE ("site_id"), CONSTRAINT "REL_a0eaf4da731fb39079b1fbf9fb" UNIQUE ("survey_point_id"), CONSTRAINT "PK_9ef709a27488ea390dd90ded05a" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
