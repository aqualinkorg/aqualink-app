...
export class UpdateMetricEnum1645518897173 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        // Edit sources enum
        await queryRunner.query(`ALTER TYPE "public"."sources_type_enum" ADD VALUE 'metlog'`);
        await queryRunner.query(`ALTER TABLE "data_uploads" ALTER COLUMN "sensor_type" TYPE "public"."sources_type_enum" USING "sensor_type"::"text"::"public"."sources_type_enum"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        // Edit sources enum
        await queryRunner.query(`CREATE TYPE "public"."sources_type_enum_old" AS ENUM('spotter', 'hobo', 'noaa', 'gfs', 'sonde')`);
