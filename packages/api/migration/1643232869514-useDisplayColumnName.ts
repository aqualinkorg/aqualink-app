...
export class useDisplayColumnName1643232869514 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TYPE "public"."site_audit_column_name_enum" RENAME TO "site_audit_column_name_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."site_audit_column_name_enum" AS ENUM('name', 'sensor_id', 'status', 'video_stream', 'max_monthly_mean', 'display')`);
        await queryRunner.query(`ALTER TABLE "site_audit" ALTER COLUMN "column_name" TYPE "text" USING "column_name"::"text"`);
        await queryRunner.query(`UPDATE site_audit
                    SET column_name = 'display'
                    WHERE column_name = 'approved'`
        );
        await queryRunner.query(`ALTER TABLE "site_audit" ALTER COLUMN "column_name" TYPE "public"."site_audit_column_name_enum" USING "column_name"::"public"."site_audit_column_name_enum"`);
        await queryRunner.query(`DROP TYPE "public"."site_audit_column_name_enum_old"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "site" RENAME COLUMN "display" TO "approved"`);
                await queryRunner.query(`CREATE TYPE "public"."site_audit_column_name_enum_old" AS ENUM('name', 'sensor_id', 'status', 'video_stream', 'max_monthly_mean', 'approved')`);
        await queryRunner.query(`ALTER TABLE "site_audit" ALTER COLUMN "column_name" TYPE "public"."site_audit_column_name_enum_old" USING "column_name"::"text"::"public"."site_audit_column_name_enum_old"`);
        await queryRunner.query(`DROP TYPE "public"."site_audit_column_name_enum"`);
        await queryRunner.query(`ALTER TYPE "public"."site_audit_column_name_enum_old" RENAME TO "site_audit_column_name_enum"`);
    }
