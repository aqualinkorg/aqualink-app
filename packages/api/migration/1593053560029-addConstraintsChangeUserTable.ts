...
export class addConstraintsChangeUserTable1593053560029 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "reef_application" DROP COLUMN "uid"`);
        await queryRunner.query(`ALTER TABLE "reef_application" ADD "uid" uuid NOT NULL DEFAULT uuid_generate_v4()`);
        ...
        await queryRunner.query(`CREATE TYPE "users_admin_level_enum_old" AS ENUM()`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "admin_level" DROP DEFAULT`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_af7cabf8e064aa7bad09c731ba" ON "users" ("location") `);
