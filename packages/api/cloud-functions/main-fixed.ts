...
import * as SiteAudit from '../src/audit/site-audit.entity';
import * as Collections from '../src/collections/collections.entity';
import * as DataUploadsSites from '../src/data-uploads/data-uploads-sites.entity';
import * as DataUploads from '../src/data-uploads/data-uploads.entity';
import * as Monitoring from '../src/monitoring/monitoring.entity';
import * as ReefCheckOrganisms from '../src/reef-check-organisms/reef-check-organisms.entity';
import * as ReefCheckSites from '../src/reef-check-sites/reef-check-sites.entity';
import * as ReefCheckSubstrates from '../src/reef-check-substrates/reef-check-substrates.entity';
import * as ReefCheckSurveys from '../src/reef-check-surveys/reef-check-surveys.entity';
import * as Regions from '../src/regions/regions.entity';
import * as SiteApplications from '../src/site-applications/site-applications.entity';
import * as SiteSketchfab from '../src/site-sketchfab/site-sketchfab.entity';
import * as SiteSurveyPoints from '../src/site-survey-points/site-survey-points.entity';
import * as DailyData from '../src/sites/daily-data.entity';
import * as ExclusionDates from '../src/sites/exclusion-dates.entity';
import * as HistoricalMonthlyMean from '../src/sites/historical-monthly-mean.entity';
import * as ScheduledUpdates from '../src/sites/scheduled-updates.entity';
import * as Sites from '../src/sites/sites.entity';
import * as Sources from '../src/sites/sources.entity';
import * as SurveyMedia from '../src/surveys/survey-media.entity';
import * as Surveys from '../src/surveys/surveys.entity';
import * as LatestData from '../src/time-series/latest-data.entity';
import * as TimeSeries from '../src/time-series/time-series.entity';
import * as Users from '../src/users/users.entity';
import * as ForecastData from '../src/wind-wave-data/forecast-data.entity';

const dbEntities = [SiteAudit, Collections, DataUploadsSites, DataUploads, Monitoring, ReefCheckOrganisms, ReefCheckSites, ReefCheckSubstrates, ReefCheckSurveys, Regions, SiteApplications, SiteSketchfab, SiteSurveyPoints, DailyData, ExclusionDates, HistoricalMonthlyMean, ScheduledUpdates, Sites, Sources, SurveyMedia, Surveys, LatestData, TimeSeries, Users, ForecastData];
...
async function runWithDataSource(
  ...
  // Create clean DataSource config avoiding TypeORM destructuring issues
  const baseConfig = dataSourceOptions as any;
  const dataSource = new DataSource({
    type: 'postgres',
    url: dbUrl,
    entities,
    synchronize: baseConfig.synchronize || false,
    logging: baseConfig.logging || false,
    logger: baseConfig.logger || 'advanced-console',
    namingStrategy: baseConfig.namingStrategy,
